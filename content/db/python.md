...
Python implementation of data structures, algorithms and design patterns. Also seeawesome-algorithms.
...
Libraries for asynchronous, concurrent and parallel execution. Also seeawesome-asyncio.
...
- [gevent](https://github.com/gevent/gevent) - A coroutine-based Python networking library that uses .
...
- [beets](https://github.com/beetbox/beets) - 
    - [beets](https://github.com/beetbox/beets) - A music library manager and  tagger.
...
- [attrs](https://github.com/python-attrs/attrs) - Replacement for , , , etc. boilerplate in class definitions.
...
- [indico](https://github.com/indico/indico) - A feature-rich event management system, made @ .
...
- [pylibmc](https://github.com/lericson/pylibmc) - A Python wrapper around the  interface.
...
Tools of static analysis, linters and code quality checkers. Also seeawesome-static-analysis.
...
- [flake8](https://github.com/PyCQA/flake8) - 
    - [flake8](https://github.com/PyCQA/flake8) - A wrapper around ,  and McCabe.
...
- [alive-progress](https://github.com/rsalmei/alive-progress) - 
    ...
    - [rich](https://github.com/Textualize/rich) - Python library for rich text and beautiful formatting in the terminal. Also provides a great  log handler.
...
- [copier](https://github.com/copier-org/copier) - 
    ...
    - [tmuxp](https://github.com/tmux-python/tmuxp) - A  session manager.
...
- [pytesseract](https://github.com/madmaze/pytesseract) - A wrapper for .
- [tesserocr](https://github.com/sirfz/tesserocr) - Another simple, Pillow-friendly, wrapper around the  API for OCR.
...
- [jsonschema](https://github.com/python-jsonschema/jsonschema) - An implementation of  for Python.
...
Libraries for visualizing data. Also seeawesome-javascript.
...
- [pygraphviz](https://github.com/pygraphviz/pygraphviz/) - Python interface to .
...
- [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/) - 
    - [mysqlclient](https://github.com/PyMySQL/mysqlclient) - MySQL connector with Python 3 support ( fork).
...
- [dateutil](https://github.com/dateutil/dateutil) - Extensions to the standard Python  module.
- [pendulum](https://github.com/sdispater/pendulum) - Python datetimes made easy.
- [pytz](https://pypi.org/project/pytz/) - World timezone definitions, modern and historical. Brings the  into Python.
...
- [ipdb](https://github.com/gotcha/ipdb) - 
    - [ipdb](https://github.com/gotcha/ipdb) - IPython-enabled .
...
Frameworks for Neural Networks and Deep Learning. Also seeawesome-deep-learning.
...
- [dask](https://github.com/dask/dask) - 
    ...
    - [PySpark](https://github.com/apache/spark) - Python API.
...
- [jedi-vim](https://github.com/davidhalter/jedi-vim) - 
    ...
    - [YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - Includes -based completion engine for Python.
...
- [path.py](https://github.com/jaraco/path.py) - A module wrapper for .
...
- [more-itertools](https://github.com/erikrose/more-itertools) - More routines for operating on iterables, beyond .
- [returns](https://github.com/dry-python/returns) - A set of type-safe monads, transformers, and composition utilities.
- [cytoolz](https://github.com/pytoolz/cytoolz/) - Cython implementation of : High performance functional utilities.
...
- [curses](https://docs.python.org/3/library/curses.html) - Built-in wrapper for  used to create terminal GUI applications.
...
- [PyQt](https://doc.qt.io/qtforpython/) - Python bindings for the  cross-platform application and UI framework.
...
- [pillow](https://github.com/python-pillow/Pillow) - Pillow is the friendly  fork.
...
- [wand](https://github.com/emcconville/wand) - Python bindings for , C API for ImageMagick.
...
- [ptpython](https://github.com/jonathanslenders/ptpython) - Advanced Python REPL built on top of the .
...
- [PyICU](https://github.com/ovalhub/pyicu) - A wrapper of International Components for Unicode C++ library ().
...
Libraries for Machine Learning. Also seeawesome-machine-learning.
...
- [Spark ML](http://spark.apache.org/docs/latest/ml-guide.html) - 's scalable Machine Learning library.
- [vowpal_porpoise](https://github.com/josephreisinger/vowpal_porpoise) - A lightweight Python wrapper for .
...
- [hot-redis](https://github.com/stephenmcd/hot-redis) - 
    ...
    - [PynamoDB](https://github.com/pynamodb/PynamoDB) - A Pythonic interface for .
...
- [delegator.py](https://github.com/amitt001/delegator.py) - for Humans 2.0.
...
- [zeroRPC](https://github.com/0rpc/zerorpc-python) - zerorpc is a flexible RPC implementation based on  and .

## Science

Libraries for scientific computing. Also seePython-for-Scientists.
...
- [elasticsearch-py](https://www.elastic.co/guide/en/elasticsearch/client/python-api/current) - The official low-level Python client for .
- [pysolr](https://github.com/django-haystack/pysolr) - A lightweight Python wrapper for .
...
- [pysimdjson](https://github.com/TkTech/pysimdjson) - A Python bindings for .
- [python-rapidjson](https://github.com/python-rapidjson/python-rapidjson) - A Python wrapper around .
...
- [docxtpl](https://github.com/elapouya/python-docx-template) - 
    ...
    - [xlwt](https://github.com/python-excel/xlwt) - /  - Writing and reading data and formatting information from Excel files.
...
- [hypothesis](https://github.com/HypothesisWorks/hypothesis) - 
    ...
    - [nose2](https://github.com/nose-devs/nose2) - The successor to , based on `unittest2.
...
- [locust](https://github.com/locustio/locust) - 
    ...
    - [Selenium](https://pypi.org/project/selenium/) - Python bindings for  WebDriver.
...
- [hashids](https://github.com/davidaurelio/hashids-python) - 
    - [hashids](https://github.com/davidaurelio/hashids-python) - Implementation of  in Python.
...
Libraries for accessing third party services APIs. Also seeList of Python API Wrappers and Libraries.
...
Traditional full stack web frameworks. Also seeRESTful API.
...
- [autobahn-python](https://github.com/crossbario/autobahn-python) - WebSocket & WAMP for Python on Twisted and .
...
Your contributions are always welcome! Please take a look at thecontribution guidelinesfirst.

If you have any question about this opinionated list, do not hesitate to contact me@VintaChenon Twitter or open an issue on GitHub.
