# Nim Developer Resources

A curated list of awesome Nim frameworks, libraries,
...
- [with](https://github.com/zevv/with) - The  macro for Nim.
...
- [toml-serialization](https://github.com/status-im/nim-toml-serialization) - Flexible TOML serialization  relying on run-time type information.
...
- [nsciter](https://github.com/Yardanico/nsciter) - High-level and low-level Nim wrapper for .
...
- [Nimquery](https://github.com/GULPF/nimquery) - Library for querying HTML using CSS selectors, like JavaScript's .

### HTTP Servers

- [httpbeast](https://github.com/dom96/httpbeast) - A highly performant, multi-threaded HTTP 1.1 server ().
...
- [Nim on dev.to](https://dev.to/t/nim) - Nim blogs on .
...
- [Make a website with Nim](https://www.youtube.com/watch?v=ndzlVRWqT2E&list=PL6RpFCvmb5SGw7aJK1E4goBxpMK3NvkON) - This is a video series meant to teach people make a website with Nim using .
