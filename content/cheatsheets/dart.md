...
```dart
// abstract classâa class that canât be instantiated
...
```dart
// provide read and write access to an objectâs properties
class Cat {
    String name;
...
print('[email protected]'.isValidEmail); //Print: true
