...
Doingv.Xis the same as doing(*v).X, whenvis a pointer.
...
StructRectangleimplicitly implements interfaceShapeby implementing all of its methods.
...
The methods defined inShapeare implemented inRectangle.
