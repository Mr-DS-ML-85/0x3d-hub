...
Use themutkeyword to make it mutable.
...
A vector is declared using thevec!macro.
...
To perform type-casting in Rust one must use theaskeyword.
...
This will produce error as the scope of the variablea_numberends at the braces
