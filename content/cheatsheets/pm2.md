...
- allto act on all processes
- idto act on a specific process id
...
Read more about cluster modehere.
...
Read more about application declarationhere
...
Read more about startup script generatorhere

### Restart application on changes

Itâs pretty easy with the--watchoption
...
You can then usepm2 logsto check for restarted app logs.
