...
See also:Type/Class/ID/Universalselectors
...
See also:Adjacent/Sibling/Childselectors

### Attribute selectors

|                      |                                    |
| -------------------- | ---------------------------------- | ---------------------------- |
|a[target]| With atargetattribute |
|a[target="_blank"]| Open in new tab                    |
|a[href^="/index"]| Starts with/index|
|[class              | ="chair"]| Starts withchair|
|[class*="chair"]| containingchair|
|[title~="chair"]| Contains the wordchair|
...
| `input:indeterminate` | Withindeterminatestate |
...
|text-align:| left / rightcenter / justify | |text-transform:| capitalize / uppercase / lowercase |
{.left-text}
...
left/center/righttop/center/bottom | |background-size:| cover X Y | |background-clip:|
border-boxpadding-boxcontent-box | |background-repeat:| no-repeatrepeat-xrepeat-y | |background-attachment:| scroll/fixed/local | {.left-text}
...
- The units are cqw (âcontainer query widthâ),
- cqh (âcontainer query heightâ),
- cqi (âcontainer query inlineâ),
- cqb (âcontainer query blockâ),
