...
Suppose you want to transfer a file âfile.txtâ from server A to client B.
...
Suppose you want to transfer a file âfile.txtâ from client B to server A:
